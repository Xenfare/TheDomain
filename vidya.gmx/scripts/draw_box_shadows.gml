        ...
        //set variables for horizontal wall shadows
        if x >= true_bbox_left and x <= true_bbox_right
        {
            
            //show_debug_message("x: " + string(x) + " true_bbox_left: " + string(true_bbox_left) + " true_bbox_right: " + string(true_bbox_right))
            if y > true_bbox_top
            {
        ...
        //set variables for diagonal wall shadows
